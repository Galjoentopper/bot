...
def test_adaptive_weights():
    ...
    for i in range(20):
        signal_generator.update_model_performance("TESTEUR", "gru", 0.85, 0.08, True)

    # Continue with LightGBM poor performance
    for i in range(20):
        signal_generator.update_model_performance("TESTEUR", "lightgbm", 0.25, -0.03, False)
