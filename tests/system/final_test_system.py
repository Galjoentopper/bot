...
def test_signal_generation():
    ...
    try:
        ...
        print(
            f"[INFO] Confidence threshold: {getattr(signal_generator, 'confidence_threshold', 'N/A')}"
        )
        print(
            f"[INFO] Adaptive weighting: {getattr(signal_generator, 'adaptive_weighting', 'N/A')}"
        )
    ...
    try:
        ...
        if models_dir.exists():
            ...
            if model_files:
                ...
                print(
                    "[WARNING] No model files found - system will work but with limited functionality"
                )
        else:
