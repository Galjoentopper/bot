...
class HealthMonitor:
    ...
    def _register_default_checks(self) -> None:
        ...
        self.register_health_check(
            HealthCheck(name="cpu_usage", check_function=self._check_cpu_usage, interval=30.0)
        )
        ...
        self.register_health_check(
            HealthCheck(name="disk_usage", check_function=self._check_disk_usage, interval=60.0)
        )
