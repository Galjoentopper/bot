...
class ErrorHandler:
    ...
    def _handle_critical_situation(self) -> None:
        ...
        if hasattr(self.logger, 'logger'):
            self.logger.logger.critical("CRITICAL: Multiple critical errors detected. Initiating emergency procedures.")
        elif hasattr(self.logger, 'log_critical'):
            self.logger.log_critical("CRITICAL: Multiple critical errors detected. Initiating emergency procedures.")
        else:
            self.logger.critical("CRITICAL: Multiple critical errors detected. Initiating emergency procedures.")
