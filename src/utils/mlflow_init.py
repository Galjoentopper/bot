...
class MLflowInitializer:
    ...
    def create_experiment_meta(
        ...
        try:
            ...
            self.experiments_created.append(
                {"id": experiment_id, "name": name, "path": str(meta_file)}
            )
            return True
    ...
    def ensure_experiment(
        self, experiment_name: str, experiment_id: Optional[str] = None
    ) -> Optional[str]:
        """
    ...
    def initialize_mlflow_tracking(self, experiments: Optional[Dict[str, str]] = None) -> bool:
        ...
        try:
            ...
            logger.info(
                f"MLflow initialization complete. Created {len(self.experiments_created)} experiments"
            )
            return True
