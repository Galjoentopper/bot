...
class EnhancedValidationLogger:
    ...
    def log_validation_metrics(self, symbol: str, model_type: str, metrics: Dict[str, Any]) -> None:
    ...
    def get_schema_decision_summary(
        self, symbol: str = None, model_type: str = None, hours: int = 24
    ) -> Dict[str, Any]:
        ...
        avg_processing_time = (
            sum(d.processing_time_ms for d in filtered_decisions) / total_decisions
        )
    ...
    def export_logs(self, filepath: str, format: str = "json") -> None:
        ...
        export_data = {
            ...
            "validation_metrics": {
                k: [asdict(m) for m in v] for k, v in self.validation_metrics.items()
            },
...
def create_enhanced_logger(
    log_dir: str = "logs/validation", config: Dict[str, Any] = None
) -> EnhancedValidationLogger:
